...
import { Col, Row, Button, Collapse, Spin, Tag } from "antd";
...
class Points extends Component {
    ...
    return (
      <>
        {this.state.selectedId && (
          <Tag
            color={
              this.state.pointsData.user_details.role_permission_id !== 5
                ? _.isUndefined(this.state.pointsData.user_details.id)
                  ? "red"
                  : "#87d068"
                : "#2db7f5"
            }
          ...
          <div className="doubts-sec">
            <Row gutter={[20]}>
              <Col xs={24} sm={24} md={24} lg={24} xl={12} xxl={12}>
                <div className="circle-bar-sec bg-white mypoint-bx-shad">
                  ...
                  <div>
                    <div className="star-circle-sec abs-cen">
                      <div className="circle circle-postion abs-cen">
                        <div className="circle-bar circle2 circle-postion2 "></div>
                      </div>
                      <div>
                        <img
                          src={star}
              ...
              <Col xs={24} sm={24} md={24} lg={24} xl={12} xxl={12}>
                <div className="progress-bar-sec  circle-bar-sec bg-white mypoint-bx-shad">
            ...
            <Row gutter={[20]}>
              <Col xs={24} sm={24} md={24} lg={24} xl={12} xxl={12}>
                <div className="mypoints-cards-sec bg-white flex-row-cen mypoint-bx-shad">
                  <div>
                    <img
            ...
            <Row gutter={[20]}>
              <Col xs={24} sm={24} md={24} lg={24} xl={24} xxl={24}>
                <div className="level-benefit-sec bg-white mypoint-bx-shad">
  ...
  render() {
    ...
    return (
      <>
        <div className="my-points-details-container">{this.display()}</div>
      </>
    );
  }
}
